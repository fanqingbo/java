...
*/
/**
 * Created by fanqingbo on 2017/6/6.
 *//*
...
public class GraphOfTheGodsFactory {
    ...
    public static TitanGraph create() {
        ...
        builder.set("storage.hostname", "192.168.213.25,192.168.213.26,192.168.213.31");
        builder.set("storage.tablename", "titan1");
        builder.set("index.search.backend", "elasticsearch");
        builder.set("index.search.hostname", "192.168.213.34");
